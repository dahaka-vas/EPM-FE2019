...
Blog.prototype = new BlogData();

// --- проверка ---
const blog1 = [new BlogData().posts[0].ratings, new Blog().posts[0].ratings];
const blog2 = [new BlogData().posts[0].ratings, new Blog().posts[0].ratings];
...
function Blog () {
    this.render = (selector) => {
        ...
        this.posts.slice(0, blogCol).forEach (function (item, i) {
